...
InvalidAlgorithmParameterException, ClassNotFoundException{
  ...
  public static final String PRIVATE_KEY_FILE = "C:/keys/private3.key";
  //String to hold name of the public key file.
  public static final String PUBLIC_KEY_FILE = "C:/keys/public2.key";
    
  //Elegxos an uparxoun kleidia stis topothesies
  ...
  //Κρυπτογράφηση με Δημόσιο Κλειδί Client (text, key)
  ...
  //Κρυπτογράφηση με Ιδιωτικό Κλειδί Server (text, key)
